const data = {
	...
	"words": [
		...
		},
		{
			...
			"sound": "Miesh-co",
			"type": "group",
			"definition": "Mieszko I was the first Polish ruler to unify it and create an independent Polish country.\n[Wikipedia](https://en.wikipedia.org/wiki/Mieszko_I)\n"
		},
		{
			"word": "Zofia",
			"sound": "Zoh-fya",
		...
		},
		{
			...
			"type": "character",
			"definition": "*Topola* is *populus*, a genus of trees.\n[Wikipedia](https://en.wikipedia.org/wiki/Populus)\n"
		},
		{
			"word": "Greynuty",
			"sound": "Grey-nu-te",
			"type": "character",
			"definition": "Another pseudo-Polish word. The root word is English *grey*, and the Polish ending *-uty* implies a plural form.\nThe *y* sound is uncommon in English, the best example I could find was the *e* in [parallelepiped](https://en.wiktionary.org/wiki/parallelepiped).\n"
		},
		{
			"word": "Ułan",
			"sound": "Uh–wan",
			"type": "other",
			"definition": "A soldier of Polish light cavalry armed with a lance, a saber, and a firearm.\n[Wikipedia](https://en.wikipedia.org/wiki/Uhlan)\n"
		},
		{
			"word": "Liść",
			"sound": "¯\\_(ツ)_/¯",
